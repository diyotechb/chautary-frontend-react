...
export const Steps = [
  {
    ...
    description:
      "Browse through a diverse selection of unique and exciting destinations. From cozy cafes to thrilling outdoor excursions, there’s something for everyone.",
  },
  {
    icon: <UsersRound className="size-20 stroke-primary" />,
